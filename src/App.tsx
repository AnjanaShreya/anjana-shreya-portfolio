      ...
      <AnimatePresence mode="wait">
        {loading ? (
          <motion.div
            ...
            className="fixed inset-0 z-50 bg-[#080808] flex flex-col justify-between p-6 md:p-12 text-white"
          >
            {/* Top info row */}
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="h-1.5 w-full bg-neutral-900 rounded-full overflow-hidden border border-white/5 p-0.5">
                <motion.div
                  className="h-full bg-gradient-to-r from-accent-blue via-accent-pink to-white rounded-full"
